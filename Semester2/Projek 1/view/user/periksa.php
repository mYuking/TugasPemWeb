                  ...
                  <tr>
                    ...
                    <div class="modal fade" id="exampleModals<?=$i;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <form method="post" action="index.php?delete_periksa">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            ...
                            <input type="text" value="<?= $d['id_periksa']; ?>" name="del"style="display:none">
                    ...
                    <div class="modal fade" id="exampleModalss<?=$i;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                      <form method="post" action="index.php?edit_periksa"  enctype="multipart/form-data">
                        <div class="modal-content">
                          <div class="modal-header">
                    ...
                    <div class="modal-body"> 
                        ...
                        <div class="form-group row" style="margin-left:-120px;">
                        <label class="col-sm-2 col-form-label" style="margin-left: 150px;">Tinggi</label>
                        <div class="col-sm-6">
                            <input type="number" name="tinggi" class="form-control" placeholder="" value="<?=$d['tinggi']?>" required>
                        </div>
                        </div>  
                        <div class="form-group row" style="margin-left:-120px;">
                        <label class="col-sm-2 col-form-label" style="margin-left: 150px;">Tensi</label>
                        <div class="col-sm-6">
                            <input type="" name="tensi" class="form-control" placeholder="" value="<?=$d['tensi']?>" required>
                        </div>
                        </div>  
                        <div class="form-group row" style="margin-left:-120px;">
                        <label class="col-sm-2 col-form-label" style="margin-left: 150px;">Keterangan</label>
                        <div class="col-sm-6">
                            <textarea name="keterangan" class="form-control" placeholder="" required><?=$d['keterangan']?></textarea>
                        </div>
                        </div>  
                        <div class="form-group row" style="margin-left:-120px;">
                        <label class="col-sm-2 col-form-label" style="margin-left: 150px;">Pasien</label>
                        <div class="col-sm-6">
                            <select name="pasien_id" class="form-control"  required>
                                <?php
                                    foreach($data1 as $d1){
                                ?>
                                    <option value="<?=$d1['id_pasien']?>"><?=$d1['nama_pasien']?></option>
                                <?php 
                                    }
                                ?>
                            </select >
                        ...
                        <div class="form-group row" style="margin-left:-120px;">
                        <label class="col-sm-2 col-form-label" style="margin-left: 150px;">Paramedik</label>
                        <div class="col-sm-6">
                            <select name="paramedik_id" class="form-control"  required>
                                <?php
                                    foreach($data2 as $d1){
                                ?>
                                    <option value="<?=$d1['id_paramedik']?>"><?=$d1['nama_paramedik']?></option>
                                <?php 
                                    }
                                ?>
                            </select >
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
  <form method="post" action="index.php?add_periksa"  >
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body"> 
        ...
        <div class="form-group row" style="margin-left:-120px;">
          <label class="col-sm-2 col-form-label" style="margin-left: 150px;">Tinggi</label>
          <div class="col-sm-6">
            <input type="number" name="tinggi" class="form-control" placeholder="" required>
          </div>
        </div>  
        <div class="form-group row" style="margin-left:-120px;">
          <label class="col-sm-2 col-form-label" style="margin-left: 150px;">Tensi</label>
          <div class="col-sm-6">
            <input type="" name="tensi" class="form-control" placeholder="" required>
          </div>
        </div>  
        <div class="form-group row" style="margin-left:-120px;">
          <label class="col-sm-2 col-form-label" style="margin-left: 150px;">Keterangan</label>
