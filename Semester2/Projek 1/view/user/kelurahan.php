                  ...
                  <tr>
                    ...
                    <div class="modal fade" id="exampleModals<?=$i;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <form method="post" action="index.php?delete_kelurahan">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            ...
                            <input type="text" value="<?= $d['id_kelurahan']; ?>" name="del"style="display:none">
                    ...
                    <div class="modal fade" id="exampleModalss<?=$i;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                      <form method="post" action="index.php?edit_kelurahan"  enctype="multipart/form-data">
                        <div class="modal-content">
                          <div class="modal-header">
                          ...
                          <div class="modal-body"> 
                            ...
                            <label class="col-sm-2 col-form-label" style="margin-left: 150px;">Nama kelurahan</label>
                            <div class="col-sm-6">
                                <input type="" name="nama_kelurahan" class="form-control" placeholder="" value="<?=$d['nama_kelurahan']?>" required>
                            </div>
                            </div>    
                        </div>
                        <div class="modal-footer">
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
  <form method="post" action="index.php?add_kelurahan"  >
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body"> 
        <div class="form-group row" style="margin-left:-120px;">
          <label class="col-sm-2 col-form-label" style="margin-left: 150px;">Nama kelurahan</label>
          <div class="col-sm-6">
            <input type="" name="nama_kelurahan" class="form-control" placeholder="" required>
          </div>
        </div>  
      </div>
